...
# change the directory to access the cricket articles
os.chdir(r"cricket")
...
# make a dataframe of the filenames and docID's and export it to a csv
columns = ['filename', 'documentID']
documents = pd.DataFrame(docID_list, columns = columns)

documents.to_csv(r'\home\jovyan\assignment-1-fwadegithub\part-b\partb1.csv')
